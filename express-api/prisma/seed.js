...
async function main() {
	...
	// Jika Anda punya model TransactionItem & Transaction, jangan hapus komentar di bawah
	...
	for (const userData of usersData) {
		...
		console.log(`   ✓ Created user: ${userData.username} (${userData.role === 1 ? "Admin" : "Kasir"})`);
	}
	console.log("✅ 3 users created!\n");

	// ========== 2. DATA KATEGORI & PRODUK ==========
	console.log("📦 Preparing categories and products...");
	...
	for (const categoryName of Object.keys(categoriesWithProducts)) {
		...
		for (const productName of products) {
			const costPrice = Math.floor(Math.random() * (priceRange.max - priceRange.min + 1)) + priceRange.min;
	...
	console.log(`✅ ${allProductsData.length} products created!\n`);
