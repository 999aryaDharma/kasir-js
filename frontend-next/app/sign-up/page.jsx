...
export default function Page() {
	...
	const handleSignUp = async (e) => {
		...
		try {
			...
			await signUpUser({ username: formState.username, password: formState.password });
	...
	return (
		<div className="flex min-h-svh w-full items-center justify-center p-6 md:p-10">
			<div className="w-full max-w-sm">
				<AuthForm variant="signup" onSubmit={handleSignUp} onInputChange={handleInputChange} formState={formState} errors={errors} isLoading={isLoading} />
			</div>
		</div>
	);
}
